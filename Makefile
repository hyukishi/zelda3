...
CFLAGS:=$(if $(CFLAGS),$(CFLAGS),-O2 -Wall -Wno-deprecated-non-prototype -Wno-bitwise-op-parentheses -Wno-logical-op-parentheses -Wno-unused-variable -Wno-unused-const-variable) -I .
